...
class Model_qlhopdong extends ConnectDB{
	...
	function hopdong_update($mahopdong,$phg,$tnh,$ngl,$ngkt,$tienpd,$tiendd,$tienct,$nguoilp,$tt){
		$sql = "UPDATE hopdong SET phong='$phg', toanha='$tnh', ngaylap='$ngl', ngaykt='$ngkt', tienphaidong='$tienpd', tiendadong='$tiendd', tienconthieu='$tienct', macb='$nguoilp',trangthai='$tt' WHERE mahopdong = '$mahopdong'";
		return mysqli_query($this->con,$sql);
	}
