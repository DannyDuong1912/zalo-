...
<body>
<form method="post" action="/New-MVC/Qlphong/Timkiem_phong">
				...
				<table>
					...
					<tr>
						...
						<td  class="col3">
							<a class="link"  href="/New-MVC/Insert_phong/Themphong"><i class="fa-solid fa-floppy-disk"></i> Insert</a>
						</td>
					</tr>
				...
				<table class="table" >
					...
					<tr>
						...
						<td>
							<a class="item"  href="/New-MVC/Qlphong/Sua_phong/<?php echo $row['phong'];?>/<?php echo $row['toanha']; ?>">
							<i class="fa-solid fa-wrench item"></i></a>
						</td>
						<td>
							<a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" class="item"  href="/New-MVC/Qlphong/Xoa_phong/<?php echo $row['phong']?>/<?php echo $row['toanha']; ?>">
