...
<body>
    <form method="POST" action="/New-MVC/Qlphong/Update_phong">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    <input class="input" type="text"  name="txtphong" value="<?php echo (isset($data["phg"]))?$data["phg"]:$phg; ?>" readonly style="color: red;"/>
                </td>
            </tr>
            <tr>
                <td class="col1">
                ...
                <td class="col2">
                    <input class="input" type="text" name="txttoanha" value="<?php echo (isset($data["tnh"]))?$data["tnh"]:$tnh; ?>" readonly style="color: red;"/>
                </td>
            </tr>
