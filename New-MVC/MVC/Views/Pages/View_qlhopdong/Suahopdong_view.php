...
<body>
    <form method="POST" action="/New-MVC/Qlhopdong/Update_hopdong">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    ...
                    <option value="">--Chọn trạng thái--</option>
                        <option value="1" <?php if(isset($data['tt']) && $data['tt']==1){echo 'selected';}else{if($tt==1){echo 'selected';}} ?> >Chưa kết thúc</option>
                        <option value="0" <?php if(isset($data['tt']) && $data['tt']==0){echo 'selected';}else{if($tt==0){echo 'selected';}} ?> >Đã kết thúc</option>
