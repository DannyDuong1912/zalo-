...
<body>
			<form method="post" enctype="multipart/form-data" action="/New-MVC/Qlhopdong/Timkiem_hopdong">
				...
				<table>
					...
					<tr>
						...
						<td  class="col3">
								<a class="link" style="width: 140px;"  href="/New-MVC/Insert_hopdong/Themhopdong"><i class="fa-solid fa-floppy-disk"></i> Tạo hợp đồng</a>
						</td>
					...
					<tr>
						<td colspan="4" style="padding-bottom: 10px;padding-left:40px;padding-top:20px;">
							<fieldset style="border: 2px solid #2980B9; border-radius: 5px;  width: 875px; height: 40px; padding-top: 0px;padding-bottom:28px;">
								<legend align="left" style="color: #ff9800; font-size:18px;">Đóng tiền còn thiếu</legend>
						
									<label style="padding-left: 10px;padding-right: 10px;">Số tiền thiếu: </label>
					
									<input class="input" type="text" value="<?php if(isset($data['tk'])){echo $data['tk'];} ?>" style="color: red;" readonly>
									<label style="padding-left: 10px;padding-right: 10px;">Đóng tiền thiếu: </label>
									<input class="input" type="number" name="txtdongtienthieu" value="<?php if(isset($data['tiennhapvao'])){echo $data['tiennhapvao'];} ?>">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<button class="submit"  type="submit" name="btndongtien"><i class="fa-solid fa-money-bill-1-wave"></i> Đóng tiền</button>
							</fieldset>
						</td>
					</tr>
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							<a class="item"  href="/New-MVC/Qlhopdong/Sua_hopdong/<?php echo $row['mahopdong']; ?>">
									Sửa</a>
						</td>
						<td>
							<a class="item" onclick="return confirm('Bạn có chắc chắn muốn kết thúc hợp đồng không ?')"  href="/New-MVC/Qlhopdong/Ketthuc_hopdong/<?php echo $row['mahopdong']; ?>">
									KT</a>
						</td>
						<td>
							<a class="item" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="/New-MVC/Qlhopdong/Xoa_hopdong/<?php echo $row['mahopdong']; ?>/<?php echo $row['trangthai']; ?>/<?php echo $row['masv']; ?>">
							Xóa</a>
						</td>
					</tr>
						<?php
