...
<body>
<form method="post" action="/New-MVC/Qlthietbi/Timkiem_tb">
				...
				<table>
					...
					<tr>
						...
						<td  class="col3">
							<a class="link"  href="/New-MVC/Insert_thietbi/Themtb"><i class="fa-solid fa-floppy-disk"></i> Insert</a>
						</td>
				...
				<table class="table" >
					...
					<tr>
						...
						<td>
							<a href="/New-MVC/Qlthietbi/Sua_thietbi/<?php echo $row['phong']; ?>/<?php echo $row['toanha']; ?>">
							<i class="fa-solid fa-wrench item"></i></a>
						</td>
						<td>
							<a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="/New-MVC/Qlthietbi/Xoa_tb/<?php echo $row['phong']; ?>/<?php echo $row['toanha']; ?>/<?php echo $row['mathietbi']; ?>">
