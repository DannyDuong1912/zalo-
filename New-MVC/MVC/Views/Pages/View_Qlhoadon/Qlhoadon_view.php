...
<body>
<form method="post" enctype="multipart/form-data" action="/New-MVC/Qlhoadon/Timkiem_hoadon">
				...
				<table>
					...
					<tr>
						...
						<td  class="col3">
							<a class="link"  href="/New-MVC/Insert_hoadon/Themhd"><i class="fa-solid fa-floppy-disk"></i> Insert</a>
						</td>
					</tr>
					<tr>
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							<a href="/New-MVC/Qlhoadon/Sua_hd/<?php echo $row['hoadon'];?>/<?php echo $row['thang'];?>/<?php echo $row['nam'];?>/<?php echo $row['phong'];?>/<?php echo $row['toanha'];?>">
							<i class="fa-solid fa-wrench item"></i></a>
						</td>
						<td>
							<a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="/New-MVC/Qlhoadon/Xoa_hd/<?php echo $row['hoadon']; ?>">
