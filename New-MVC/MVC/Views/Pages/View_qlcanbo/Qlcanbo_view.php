...
<body>
<form method="post" action="/New-MVC/Qlcanbo/Timkiem_cb">
				...
				<table >
					...
					<tr>
						...
						<td class="col3" colspan="2">
							<a class="link"  href="/New-MVC/Insert_canbo/Themcb">
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							<a href="/New-MVC/Qlcanbo/Sua_cb/<?php echo $row['macb']; ?>">
							<i class="fa-solid fa-wrench item"></i></a>
						</td>
						<td>
							<a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" href="/New-MVC/Qlcanbo/Xoa_cb/<?php echo $row['macb']; ?>">
